...
\begin{frame}{Google Code Jam (Hasta 2023)}
    \begin{block}{Organización de la Competencia Más Grande del Mundo}
        \begin{itemize}
            \item Lideró el diseño de problem statements y la infraestructura de Google Code Jam como Ingeniero de Software.
            \item Responsable de la calidad de los problem statements resueltos por cientos de miles de competidores mundialmente.
            \item Organizó y acompañó el certamen hasta su histórica edición de cierre en \textbf{2023}.
        \end{itemize}
    \end{block}
    \centering
    \includegraphics[height=2.0cm,keepaspectratio]{gcj_logo.png}
\end{frame}
