    ...
    \begin{columns}
        ...
        \begin{block}{Baku, Azerbaiyán 2025}
            \begin{itemize}
                ...
                \item \textbf{Logro}: Puesto \textbf{110} a nivel mundial -- \textbf{8°} lugar en América Latina (5 problemas resueltos).
            \end{itemize}
        \end{block}
        \vspace{0.1cm}
...
\begin{frame}{Palabras de Bienvenida}
    ...
    \begin{itemize}
        ...
        \item \textbf{Javier Díaz} -- Secretario de Vinculación e Innovación Tecnológica de la UNLP
    \end{itemize}
\end{frame}
...
\begin{frame}{Aulas y Espacios de Trabajo}
    \begin{columns}
        \column{0.55\textwidth}
        \begin{block}{Clases Teóricas}
            \begin{itemize}
                \item \textbf{Nivel Inicial}: Aula 11
                \item \textbf{Nivel Avanzado}: Aula 5
            \end{itemize}
        \end{block}
        
        \begin{block}{Simulaciones (Práctica)}
            \begin{itemize}
                \item \textbf{Laboratorio}: Aula 8
                \item \textbf{Notebooks personales}: Habilitada toda la Planta Baja (se abrirán más aulas a medida que se requieran enchufes).
            \end{itemize}
        \end{block}
        
        \column{0.45\textwidth}
        \centering
        \includegraphics[width=\textwidth,keepaspectratio]{img/plano.jpg}\\
        \vspace{0.2cm}
        \small{Plano de la Facultad}
    \end{columns}
\end{frame}
