...
\item \textbf{Total de Problemas (incluyendo duplicados):} 212
\item \textbf{Problemas Únicos:} 148
\item \textbf{Promedio por Contest:} 13.25 problemas
\end{itemize}
...
\fill[blue!80] (7.6,0) rectangle (7.9,0.884); % Day 8 (221)

% Bars for Avanzado submissions (red)
\fill[red!80] (1.1,0) rectangle (1.4,7.512); % Day 1 (1878)
\fill[red!80] (2.1,0) rectangle (2.4,5.620); % Day 2 (1405)
\fill[red!80] (3.1,0) rectangle (3.4,4.788); % Day 3 (1197)
\fill[red!80] (4.1,0) rectangle (4.4,4.808); % Day 4 (1202)
\fill[red!80] (5.1,0) rectangle (5.4,4.764); % Day 5 (1191)
\fill[red!80] (6.1,0) rectangle (6.4,3.836); % Day 6 (959)
\fill[red!80] (7.1,0) rectangle (7.4,5.568); % Day 7 (1392)
\fill[red!80] (8.1,0) rectangle (8.4,4.020); % Day 8 (1005)
...
\pie[text=legend, radius=1.8, sum=auto, after number=\%]
  {50.2/C++23, 30.6/C++20, 13.9/C++17, 5.0/Python, 0.3/Otros}
\end{tikzpicture}

\vspace{0.3cm}
\small
\textbf{Otros incluye:} Java 21 (19) y GNU C11 (18)
\end{center}
\end{frame}
...
\begin{tikzpicture}
\pie[text=legend, radius=1.8, sum=auto, after number=\%]
  {44.9/Wrong Answer, 41.3/Accepted, 5.6/Time Limit, 4.5/Compilation, 3.7/Runtime Error}
\end{tikzpicture}
\end{center}
\end{frame}
...
\item \textbf{Más Submissions:} [AVANZADO] TCArg 2026 Contest \#1 (1,878)
\item \textbf{Promedio Submissions:} 833 por contest
\item \textbf{Participantes Únicos:} 471 total
\end{itemize}
\end{center}
\end{frame}
...
\large
\begin{itemize}
\item \textbf{Submissions/Participante:} 28.3 promedio
\item \textbf{Mejor Contest Inicial:} [INICIAL] TCArg 2026 Contest \#7 (53.8\% accepted)
\item \textbf{Contest Más Difícil:} [AVANZADO] TCArg 2026 Contest \#8 (33.2\% accepted)
...
\normalsize
\begin{itemize}
\item \textbf{471 participantes únicos}
\item \textbf{13335 submissions analizadas}
\item \textbf{212 problemas disponibles}
