...
\begin{itemize}
    ...
    \texttt{losdistintos: nukkua, Riptide25} en \textbf{2m 0s} \\
    ...
    \texttt{por la ultima con pelo: tonimondejar} a falta de \textbf{1m 0s} \\
    {\footnotesize (Contest \#8 Avanzado, Problema L - Second price auction)}
\end{itemize}
\end{center}
\end{frame}
